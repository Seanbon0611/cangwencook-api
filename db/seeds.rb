sean = User.create(first_name: 'Sean', last_name: 'Dever', email: 'seand0611@gmail.com', password: 'seandever', is_admin: true)
gwen = User.create(first_name: 'Gwen', last_name: 'Sioson', email: 'gwenpsioson@gmail.com',  password: 'gwensioson', is_admin: true)
