...
korean_taco = Recipe.create(title: "Korean Ground Beef Tacos", description: "Korean-inspired flavors in the form of tacos", image: "https://can-gwen-cook.s3-us-west-1.amazonaws.com/korean-tacos.jpg", keto: true, gluten_free:true, low_calorie: true, paleo: true, dairy_free: true, vegetarian: false, quick: true, calories: 1200, net_carbs: 11, protein: 165, fat:89)
miso_lambchop = Recipe.create(title: "Miso Glaze Lambchops", description: "Miso Glaze Lambchop packed full of flavor", image: "https://can-gwen-cook.s3-us-west-1.amazonaws.com/lambchops.jpg", keto: true, gluten_free: true, low_calorie: false, paleo: true, dairy_free: true, vegetarian: false, quick: false, calories: 750, net_carbs: 1, protein: 70, fat:45)
three_scones = Recipe.create(title: "Scone Party", description: "Three different flavored scones", image: "https://can-gwen-cook.s3-us-west-1.amazonaws.com/scones.jpg", keto: true, gluten_free:true, low_calorie: false, paleo: false, dairy_free: false, vegetarian: false, quick: true, calories: 1100, net_carbs: 7, protein: 25, fat:60)
